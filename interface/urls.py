...
urlpatterns = [
    ...
    url(r'^campaigns/delete/(?P<item_pk>[0-9]+)/$', views.delete_campaignentry, name='delete_campaignentry'),
    url(r'^campaigns/reorder/$', views.reorder_campaignentry, name='reorder_campaignentry'),
